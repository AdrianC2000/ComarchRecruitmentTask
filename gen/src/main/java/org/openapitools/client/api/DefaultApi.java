...
public class DefaultApi {
    ...
    private okhttp3.Call helloGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = helloGetCall(_callback);
        return localVarCall;
     ...
     */
    public String helloGet() throws ApiException {
        ApiResponse<String> localVarResp = helloGetWithHttpInfo();
     ...
     */
    public ApiResponse<String> helloGetWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call helloGetAsync(final ApiCallback<String> _callback) throws ApiException {
